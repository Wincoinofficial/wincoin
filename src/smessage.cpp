// Copyright (c) 2014 The WinCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("WinCoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("WinCoin-smsg-pow"); // Make this thread recognisable
