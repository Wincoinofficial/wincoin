...
{
    resize(950, 550);
    setWindowTitle(tr("WinCoin4.0"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/WinCoin"));
    setWindowIcon(QIcon(":icons/WinCoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the WinCoin Blockchain"));
