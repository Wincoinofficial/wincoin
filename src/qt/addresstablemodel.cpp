...
public:
    ...
    void updateEntry(const QString &address, const QString &label, bool isMine, int status)
    {
        ...
        case CT_UPDAWC:
            if(!inModel)
            {
                OutputDebugStringF("Warning: AddressTablePriv::updateEntry: Got CT_UPDAWC, but entry is not in model\n");
                break;
            }
        ...
        case CT_DELEWC:
            if(!inModel)
            {
                OutputDebugStringF("Warning: AddressTablePriv::updateEntry: Got CT_DELEWC, but entry is not in model\n");
                break;
            }
